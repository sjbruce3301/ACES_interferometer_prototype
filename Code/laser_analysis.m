laser_filename = '07_18_ds2.seq'; %input main file name                %CHANGE THIS PER FILE
...
fname = '07_18_ds2.csv';                                                %CHANGE THIS PER FILE
...
figure(1)
ax(4) = subplot(4,1,1);
plot(ts_sec + 0.75,intensity_plot, linewidth = 1.3)
%xlim([7.2,7.4])
ylabel('Intensity')
xlabel('Time (s)')
...
%%
timealigned_camera = ts_sec + 0.75;
camera_pos = interp1(t1, x1, timealigned_camera);
