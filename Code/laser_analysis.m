laser_filename = '07_06_closedloop_ds4.seq'; %input main file name                %CHANGE THIS PER FILE
dark_filename = '07_06_DARK.seq'; %input dark file name                      %CHANGE THIS PER FILE
...
fname = '07_06_closedloop_ds4.csv';                                                %CHANGE THIS PER FILE
...
figure(1)
ax(4) = subplot(4,1,1);
plot(ts_sec + 0.0,intensity_plot, linewidth = 1.3)
%xlim([7.2,7.4])
ylabel('Intensity')
xlabel('Time (s)')
...
fourier_transform = fft(intensity_plot(1726:1760));
